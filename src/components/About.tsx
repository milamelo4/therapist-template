...
const About = () => {
  ...
  return (
    <section
      id="about"
      className={`py-10 sm:py-20 px-4 bg-gradient-section min-h-[100svh] md:min-h-screen `}      
    >
          ...
          >
            ...
            <div className="space-y-4 text-text-soft leading-relaxed">
              ...
              <p>
                ...
                transformation. I work with children, adolescents, and adults —
                focusing on each person's unique story.
              </p>
              <p>
                I believe that therapy is not one-size-fits-all. Each individual
                brings a unique set of experiences, strengths, and challenges.
                My goal is to walk alongside you with empathy and honesty,
                creating a space where you feel truly seen and supported.
              </p>
              <p>
                Whether you're seeking to understand yourself better, navigate
                life's challenges, or simply need someone to listen, I'm here
                to help. Let's embark on this journey of self-discovery
                together.
              </p>
            </div>
          </div>
          ...
          >
            ...
            <div className="bg-card p-8 rounded-lg shadow-soft mt-6 border border-lavender-light">
              <p className="text-text-calm font-medium">
                “Healing begins the moment someone feels truly heard.”<br />—
                Dr Elena Reyes
              </p>
            </div>
          </div>
